  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#0D0D0D] p-6">
      <Card className="w-full max-w-md flex flex-col items-center gap-6 !p-8 text-center">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#F5F5F7]">Create your account</h1>
          <p className="text-sm text-[#A0A0A0] mt-2">
            One Privy flow handles both signup and login — email, Google, or wallet.
          </p>
        </div>
        ...
        <a href="/login" className="text-xs text-[#00C896] hover:underline">
